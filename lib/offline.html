    ...
    <div class="container-fluid">
        ...
        <div class="errorContainer offline">
            <div class="page-header">
                <h1 class="center">Our site is OFFLINE</h1>
            </div>

            <h2 class="center">Some big improvements be made. Please come back later!</h2>
            ...
            <div class="social">
                <ul class="unstyled">
                    <li><span class="icon16 icomoon-icon-twitter-2 blue"></span><a href="#">Keep in touch with twitter</a></li>
                    <li><span class="icon16 icomoon-icon-facebook-2 blue"></span><a href="#">Leave comment in facebook</a></li>
                </ul>
            </div>
